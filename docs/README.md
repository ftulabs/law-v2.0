...
| [`reference/`](reference/) | Organiser-provided material — hackathon overview, Zone-3 scoring FAQ & criteria. |
| [`examples/`](examples/) | Sample CSV/JSON output. |

The official submission templates and the answer-key database stay in the repo root
(`OUTPUT_TEMPLATE_31MAY.xlsx`, `ESCAP-RDTII-2.1_ Round 1 Database.xlsx`) because tooling loads them from there.
